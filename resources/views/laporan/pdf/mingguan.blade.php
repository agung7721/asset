...
<body>
    ...
    <div class="summary">
        <div class="summary-title">Rekap Mingguan</div>
        <table>
            <thead>
                <tr>
                    <th>Tanggal</th>
    ...
    <div class="summary">
        <div class="summary-title">Histori Perbaikan Minggu Ini</div>
        <table>
            <thead>
                <tr>
                    <th>No</th>
            ...
            <tbody>
                @forelse($data['weeklyTotal']['perbaikan_history'] ?? [] as $index => $history)
                <tr>
                    <td>{{ $index + 1 }}</td>
                ...
                @empty
                <tr>
                    <td colspan="7" style="text-align:center;">Tidak ada data perbaikan minggu ini</td>
                </tr>
                @endforelse
            </tbody>
        </table>
